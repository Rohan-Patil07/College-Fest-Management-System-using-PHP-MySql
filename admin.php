...
<?php
       if ($_POST['submit']){
        ...
        $sql="SELECT name,email, pass FROM admin WHERE email='$username' AND pass='$password'";
		...
		if($username== $dbusername && $password== $dbpassword){
          ...
          header('location:/fest/home/home.html');
		}else{
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" name= "form" action="admin.php", method="post">
