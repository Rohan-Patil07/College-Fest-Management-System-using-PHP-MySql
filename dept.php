...
<?php
       if ($_POST['submit']){
        ...
        $sql="SELECT dname,did, pass FROM dept WHERE did='$username' AND pass='$password'";
		...
		if($username== $dbusername && $password== $dbpassword){
		  ...
		  $_SESSION['deptname']= $userId;
		  
		  echo "session added index.html calling";
          header('location:/fest/home/dept/depthome.html');
		}else{
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" name= "form" action="dept.php", method="post">
