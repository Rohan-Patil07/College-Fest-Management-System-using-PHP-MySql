...
<?php
       if ($_POST['submit']){
        ...
        $sql="SELECT name,usn, pass FROM student WHERE usn='$username' AND pass='$password'";
		...
		if($username== $dbusername && $password== $dbpassword){
		  ...
		  $_SESSION['studname']= $userId;
		  
		  echo "session added index.html calling";
          header('location:/fest/home/student/studhome.php');
		}else{
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" name= "form" action="stud.php", method="post">
